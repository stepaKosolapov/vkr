set(OBJ_STL
   ...
   diffusion3/lib/main/attrs.cc diffusion3/lib/main/events.cc
   diffusion3/lib/main/iodev.cc diffusion3/lib/main/iohook.cc
   diffusion3/lib/main/timers.cc diffusion3/lib/main/message.cc
...
set(OBJ_CC
	...
	common/scheduler.cc common/object.cc common/packet.cc 
	common/ip.cc routing/route.cc common/connector.cc common/ttl.cc 
	trace/trace.cc trace/trace-ip.cc 
	classifier/classifier.cc classifier/classifier-addr.cc 
	classifier/classifier-hash.cc 
	classifier/classifier-virtual.cc 
	classifier/classifier-mcast.cc 
	classifier/classifier-bst.cc 
	classifier/classifier-mpath.cc mcast/replicator.cc 
	...
	qs/qsagent.cc qs/hdr_qs.cc 
	apps/app.cc apps/telnet.cc tcp/tcplib-telnet.cc 
	tools/trafgen.cc trace/traffictrace.cc tools/pareto.cc 
	tools/expoo.cc tools/cbr_traffic.cc 
	adc/tbf.cc adc/resv.cc adc/sa.cc tcp/saack.cc 
	tools/measuremod.cc adc/estimator.cc adc/adc.cc adc/ms-adc.cc 
	adc/timewindow-est.cc adc/acto-adc.cc 
        adc/pointsample-est.cc adc/salink.cc adc/actp-adc.cc 
	adc/hb-adc.cc adc/expavg-est.cc
	adc/param-adc.cc adc/null-estimator.cc 
	...
	common/ivs.cc 
	common/messpass.cc common/tp.cc common/tpm.cc apps/worm.cc 
	tcp/tcp.cc tcp/tcp-sink.cc tcp/tcp-reno.cc 
	tcp/tcp-newreno.cc 
	...
	tcp/tcp-asym.cc tcp/tcp-asym-sink.cc tcp/tcp-fs.cc 
	tcp/tcp-asym-fs.cc 
	tcp/tcp-int.cc tcp/chost.cc tcp/tcp-session.cc 
	tcp/nilist.cc 
	...
	sctp/sctpDebug.cc 
        ...
        dccp/dccp_tfrc.cc 
	tools/integrator.cc tools/queue-monitor.cc 
	tools/flowmon.cc tools/loss-monitor.cc 
	...
	$(LIB_DIR)int.Vec.cc $(LIB_DIR)int.RVec.cc 
	$(LIB_DIR)dmalloc_support.cc 
	...
	webcache/mcache.cc webcache/webtraf.cc 
	webcache/webserver.cc 
	webcache/logweb.cc 
	empweb/empweb.cc 
	empweb/empftp.cc 
	realaudio/realaudio.cc 
	mac/lanRouter.cc classifier/filter.cc 
	common/pkt-counter.cc 
	common/Decapsulator.cc common/Encapsulator.cc 
	common/encap.cc 
	...
	mac/mac-timers.cc trace/cmu-trace.cc mac/varp.cc 
	mac/mac-simple.cc 
...
set(OBJ_C
	...
	tcp/linux/src/tcp_highspeed.c tcp/linux/src/tcp_bic.c tcp/linux/src/tcp_htcp.c tcp/linux/src/tcp_scalable.c tcp/linux/src/tcp_cubic.c
	tcp/linux/src/tcp_westwood.c tcp/linux/src/tcp_vegas.c tcp/linux/src/tcp_hybla.c
	tcp/linux/src/tcp_illinois.c tcp/linux/src/tcp_yeah.c 
	tcp/linux/src/tcp_veno.c tcp/linux/src/tcp_compound.c tcp/linux/src/tcp_lp.c
	tcp/linux/ns-linux-c.c tcp/linux/ns-linux-param.c
)
